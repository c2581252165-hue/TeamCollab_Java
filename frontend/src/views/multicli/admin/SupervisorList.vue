<template>
  <div class="h-full space-y-6 animate-in pb-8">
    <div class="flex items-center justify-between">
      <h2 class="text-xl font-semibold text-zinc-900 tracking-tight">Supervisor 管理</h2>
    </div>
...
onMounted(async () => { loading.value = true; try { const r = await api.get('/admin/supervisors'); list.value = r.data.records; } catch(e){ console.error(e) } loading.value = false })
</script>
